...
export interface BlueConicClientStatic {
    ...
    createConversionEventWithCallback(interactionId: string, properties: PropertyBag, callback: VoidCallback): void;
...
declare const BlueConicClient: BlueConicClientStatic;
